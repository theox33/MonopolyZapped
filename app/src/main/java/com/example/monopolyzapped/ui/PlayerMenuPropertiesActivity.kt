...
class PlayerMenuPropertiesActivity : AppCompatActivity() {
    ...
    private lateinit var btnUnmortgage: ImageButton
    private lateinit var btnBuy: ImageButton
    private lateinit var btnAuction: ImageButton
    ...
    private fun wireClicks() {
        ...
        btnBuy.bindClickWithPressAndSound {
            val intent = Intent(this, PlayerMenuPropertiesBuyActivity::class.java).apply {
                putExtra(PlayerMenuPropertiesBuyActivity.EXTRA_PLAYER_INDEX, playerIndex)
                putExtra(PlayerMenuPropertiesBuyActivity.EXTRA_TURN_INDEX, currentTurnIndex)
                if (Build.VERSION.SDK_INT >= 33) {
        ...
        btnMortgage.bindClickWithPressAndSound {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_player_menu_properties)
