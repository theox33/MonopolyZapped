...
class PlayerMenuPropertiesSellActivity : AppCompatActivity() {
    ...
    private fun wireClicks() {
        ...
        btnOk.setOnClickListener {
            ...
            playCongratsThen {
                val i = Intent(this, PlayerMenuStartCardScanActivity::class.java).apply {
                    // joueurs
                    ...
                    // indices 0-based attendus par PlayerMenuStartCardScanActivity
                    putExtra(PlayerMenuActivity.EXTRA_PLAYER_INDEX, playerIndex)
                    putExtra(PlayerMenuActivity.EXTRA_TURN_INDEX, currentTurnIndex)

                    // 💰 montant en K saisi dans cette activité (remplace le défaut 2M)
                    putExtra(PlayerMenuStartCardScanActivity.EXTRA_AMOUNT_K, amountK)

                    // options (inchangées)
                    putExtra(PlayerMenuStartCardScanActivity.EXTRA_SHOW_BACK, true)
                    putExtra(PlayerMenuStartCardScanActivity.EXTRA_DEBUG_OVERLAY, true)
                }
